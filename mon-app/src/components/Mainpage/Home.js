    ...
    return(
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ height: 500 }}>
          <h1 className="topStyle">Meta NFT</h1>
      ...
      <div className="NFT" style={{ display: 'flex', justifContent: 'space-between'}}>
        ...
        <p className="nft" style ={{textAlign: 'jusitfy', justifyContent: 'center'}}>Et bien c'est assez simple,Mais qu’est-ce qu’un NFT exactement ? Encore un accronyme assez opaque de prime abord. NFT vient de l’anglais Non Fongible Token soit jeton non fongible.  Les NFT sont nouveaux et fascinants. 
